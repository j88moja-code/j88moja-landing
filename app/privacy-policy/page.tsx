export default function Page() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="mb-4">
        Welcome to J88Moja Systems. We are committed to protecting your personal
        information and your right to privacy. If you have any questions or
        concerns about this privacy notice or our practices with regard to your
        personal information, please contact us at support@yourcompany.com.
      </p>
      ...
      <p className="mb-4">
        ...
        data, including the right to request access, correction, erasure,
      ...
      <p>
        ...
        info@j88moja.tech or by post to:
      </p>
