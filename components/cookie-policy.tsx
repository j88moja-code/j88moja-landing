      ...
      <Container className='mx-auto px-4 py-8'>
        ...
        <Balancer>
          ...
          <p className='mb-4'>
            ...
            through the website (e.g., like advertising, interactive content,
          ...
          <p className='mb-4'>
            ...
            necessary" cookies. Some cookies also are "performance cookies,"
            which are used to assess how effective our marketing campaigns are
            for you. You have the ability to accept or decline these cookies,
            but please note that if you do not accept all of these cookies, you
            may not be able to use some parts of our Website correctly or at
            all.
          </p>
          ...
          <p className='mb-4'>
            ...
            automatically deleted from your personal computer or mobile device
            when you close your web browser. You can set your browser to block
            or alert you before accepting new cookies, but some features of our
