    ...
    <section id="contact" className="overflow-hidden py-16 md:py-20 lg:py-28">
      <div className="container">
        ...
        <p className="mb-4">
          ...
          effective our marketing campaigns are for you. You have the ability to
          accept or decline these cookies, but please note that if you do not
          accept all of these cookies, you may not be able to use some parts of
        ...
        <p className="mb-4">
          ...
          when you visit our Website for the duration of your visit. Session
          Cookies are automatically deleted from your personal computer or
          mobile device when you close your web browser. You can set your
          browser to block or alert you before accepting new cookies, but some
        ...
        <p className="mb-4">
          ...
          cookies we use. If you have any further questions or comments, please
          email us at info@j88moja.tech.
        </p>
      </div>
    </section>
  );
