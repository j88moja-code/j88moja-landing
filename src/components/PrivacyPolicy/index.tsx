    ...
    <section id="contact" className="overflow-hidden py-16 md:py-20 lg:py-28">
      <div className="container">
        ...
        <p className="mb-4">
          ...
          products and services, participate in activities on the Services, or
        ...
        <ul className="mb-4 list-disc pl-6">
          <li>
            <strong>Browser tab information:</strong> This includes details like
            the title, URL, and favicon of your open browser tabs.
          </li>
          <li>
            <strong>Tab metadata:</strong> Information such as the date and time
            a tab was opened, and its status (active or inactive).
          </li>
          <li>
        ...
        <ul className="mb-4 list-disc pl-6">
          ...
          <li>
            <strong>Enhance user experience:</strong> Providing personalized tab
            management features based on your browsing behavior.
          </li>
          <li>
            <strong>Provide product improvements:</strong> Using usage data to
            identify areas of improvement and add new features to the extension.
          </li>
        </ul>
        ...
        <p className="mb-4">
          ...
          legal bases: Consent, Legitimate Interests, Performance of a Contract,
        ...
        <p className="mb-4">
          ...
          Therefore, we cannot guarantee that hackers, cybercriminals, or other
          unauthorized third parties will not be able to defeat our security
          measures and improperly collect, access, steal, or modify your
          information.
        </p>
        ...
        <p className="mb-4">
          ...
          portability, and (where the lawful ground of processing is consent) to
          withdraw consent.
        </p>
        <p className="mb-4">
          For <strong>Tabber</strong> users, you have full control over the
          information it accesses. The data collected from your browser tabs is
          solely for enhancing your experience and is not stored or used for any
          purpose other than providing the extension&apos;s tab management features.
        </p>
        ...
        <p>
          ...
          at info@j88moja.tech. Our location is:
        </p>
